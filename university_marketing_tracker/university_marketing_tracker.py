...
def mobile_overview():
    return rx.mobile_and_tablet(
        rx.vstack(
            ...
            rx.vstack(
                usp_card("1. ISP", "Industry Specialist Professionals"),
                usp_card("2. BEE", "Entrepreneurship Ecosystem"),
                usp_card("3. WOCA", "World Is Our Campus"),
                usp_card("4. LII", "Learning In Industry"),
                usp_card("5. BTI", "Guaranteed Internships"),
                width="100%", spacing="3",
            ),
